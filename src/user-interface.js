...
const elementCreator = (() => {
  ...
  function projectToElment (project) {
    ...
    xSign.onclick = function () {
      ...
      const projectName = tempP.getTitle()
  ...
  function _initProjectBtn () {
    const element = document.querySelector('#add-project-btn')
    element.onclick = function () {
  ...
  function _initNewProjectForm () {
    const element = document.querySelector('#popup-form')
    return element
  }
  ...
  function _initAddBtn () {
    ...
    element.onclick = function () {
      ...
      const inputForm = dom.getInputForm()
      if (inputForm.value === '') {
  ...
  function _initCancelBtn () {
    const element = document.querySelector('#cancel-btn')
    element.onclick = function () {
  ...
  function _initForm () {
    const element = document.querySelector('#new-project-name')
    return element
  }
  ...
  function _initPlusIcon () {
    const element = document.querySelector('#plus-icon')
    element.onclick = function () {
  ...
  function _initModalCancelBtn () {
    const element = document.querySelector('#modal-cancel-btn')
  ...
  function _initModalAddBtn () {
    const element = document.querySelector('#modal-add-btn')
  ...
  function _taskCreatorHelper () {
    const title = dom.getModalTaskForm().value
    ...
    const task = taskHandler.newTask(title, '', date)
